...
dValue = dValue.replace(/^0+/, ""); // 金额数值转字符、移除逗号、移除前导零   
              ...
              else if (isNaN(dValue)) { return '<asp:Literal ID="Literal2" Text="AlertInputLawful" runat="server"></asp:Literal>'; }
              ...
              if (vInt.length > 44) { return '<asp:Literal ID="Literal3" Text="alert" runat="server"></asp:Literal>'; }
